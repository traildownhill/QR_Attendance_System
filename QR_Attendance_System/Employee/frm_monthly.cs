...
{
    public partial class frm_monthly : Form
    {
        String selected_id, logged_id;
        public frm_monthly(string selected_id, string logged_id)
        {
            InitializeComponent();
        ...
        private void dateTimePicker1_ValueChanged(object sender, EventArgs e)
        {
            ...
            label5.Text = "End: " + dTime.AddDays(30).ToString("MM/dd/yyyy");
            bunifuButton1.Enabled = true;

            DataTable dt = Employee.GetData("SELECT * FROM `tbl_am` WHERE Employee_ID = '" + selected_id + "' AND Date BETWEEN '" + dTime.ToString("MM/dd/yyyy") + "' AND '" + dTime.AddDays(30).ToString("MM/dd/yyyy") + "'");
            ...
            DataTable dt1 = Employee.GetData("SELECT * FROM `tbl_pm` WHERE Employee_ID = '" + selected_id + "' AND Date BETWEEN '" + dTime.ToString("MM/dd/yyyy") + "' AND '" + dTime.AddDays(30).ToString("MM/dd/yyyy") + "'");
